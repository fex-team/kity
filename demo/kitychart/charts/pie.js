var kityPie = kity.createClass({
    ...
    constructor: function(r, R, a1, a2, x, y) {
        ...
        this.center = kity.Vector.fromPolar((R + r) / 2, (a1 + a2) / 2);
    },
    draw: function(r, R, a1, a2, x, y) {
        var d = this.getDrawer();
        var p1 = kity.Vector.fromPolar(r, a1),
            p2 = kity.Vector.fromPolar(R, a1),
            p3 = kity.Vector.fromPolar(R, a2),
            p4 = kity.Vector.fromPolar(r, a2);
